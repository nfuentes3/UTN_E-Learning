...
db = SqliteDatabase('ordenes_lavadero.db') #Se crea una instancia de base, con la base de datos con Sqlite3.

"""
    Indice de clases:
    =================
    Las clases incluidas en el modulo son los siguientes:
    .. toctree::
        :maxdepth: 2
        :caption: Clases:
