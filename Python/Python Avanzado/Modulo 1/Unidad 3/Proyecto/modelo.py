...
def alerta_consola(func):
    def envoltura(*args, **kwargs):
        if func.__name__ == "alta":
            print("Nueva orden generada (decorador)")
            resultado = func(*args, **kwargs)
            return resultado
        elif func.__name__ == "borrar":
            print("Orden eliminada (decorador)")
            resultado = func(*args, **kwargs)
            return resultado
        elif func.__name__ == "modificar":
            print("Orden modificada (decorador)")
            resultado = func(*args, **kwargs)
            return resultado
    return envoltura
