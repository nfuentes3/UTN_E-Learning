        ...
        try:
            ...
            if re.match(r"^\d+$", telefono) and re.match(
                ...
                self.cliente_socket.send(
                    f"Nueva orden generada: {nombre}, {telefono}".encode()
                )
    ...
    def borrar(self):
        try:
            ...
            if not id_orden:
                ...
                self.actualizar_tree()
                self.vista.alerta(
                    f"La orden {id_orden} fue eliminada", COLOR_ERROR, TEXT_INFO
                )
                self.cliente_socket.send(f"Orden eliminada: {id_orden}".encode())
        except Exception as err:
    ...
    def modificar(self):
        try:
            ...
            if id_orden == "":
                ...
                self.vista.limpiar_entrys()
                self.vista.alerta(
                    f"La orden {id_orden} fue modificada", COLOR_INFO, TEXT_INFO
                )
        except Exception as err:
    ...
    def borrar_todo(self):
        try:
            ...
            if respuesta == True:
                ...
                self.vista.alerta(
                    "Se han eliminado todas las ordenes.", COLOR_INFO, TEXT_INFO
                )
            else:
    ...
    def balance_total(self):
        ...
        for orden in resultado:
            ...
            if self.vista.entry_balance == "":
                ...
                self.vista.alerta(
                    f"El total a recuadar es de ${total}", COLOR_INFO, TEXT_INFO
                )
            else:
